...
/**
 * @author Stephane Abdallah class de configuration de la base de donnée, driver
 *         JDBC, transaction manager, provider, EntityManager
 *
 */
...
@ComponentScan(basePackages = { "org.formation.spring" }) // ï¿½couvrir les coumposants
public class ApplicationConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl(environment.getProperty("jdbc.url")); // c'est ce qui nous permet de rï¿½cuperer le fichier
																// property
